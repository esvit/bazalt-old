...
//			f.top -= po.y;
			...
			if (!f.type) {
				...
				DOM.add(id + '_wrapper', 'a', {id : id + '_ok', 'class' : 'mceButton mceOk btn btn-success', href : 'javascript:;', onmousedown : 'return false;'}, 'Ok');
			...
			clf = Event.add(id, 'click', function(e) {
				...
				if (n.nodeName == 'A' || n.nodeName == 'a') {
					switch (n.className) {
						...
						case 'mceButton mceOk btn btn-success':
						case 'mceButton mceCancel btn':
							f.button_func(n.className == 'mceButton mceOk btn btn-success');
							return Event.cancel(e);
					}
				}
			});
