<?php
    $group_stats      = Logger::group_stats();
...
<div class="kohana">
	<?php foreach (Logger::groups() as $group => $benchmarks): ?>
	<table class="profiler">
		<tr class="group">
			<th class="name" rowspan="2"><?php echo $group ?></th>
		...
		<tr class="mark time">
			<?php $stats = Logger::stats($tokens) ?>
			<th class="name" rowspan="2" scope="rowgroup"><?php echo htmlentities($name), ' (<strong>', count($tokens), '</strong>)' ?></th>
			<?php foreach ($group_cols as $key): ?>
	...
	<table class="profiler">
		<?php $stats = Logger::application($app) ?>
		<tr class="final mark time">
			<th class="name" rowspan="2" scope="rowgroup"><?php echo __('Application Execution').' (<strong>'.$stats['count'].'</strong>)' ?></th>
