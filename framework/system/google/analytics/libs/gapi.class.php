<?php
// $Id: gapi.class.php 33 2010-08-29 17:33:02Z esvit $
...
class gapiClientLogin extends gapiAuthMethod {
   ...
   */
  protected function fetchToken($email, $password, $logintoken = null, $logincaptcha = null) {
    $post_variables = array(
      'accountType' => 'GOOGLE',
      'Email' => $email,
      'Passwd' => $password,
    ...
    if ($logintoken != null && $logincaptcha != null) {
        $post_variables['logintoken'] = $logintoken;
        $post_variables['logincaptcha'] = $logincaptcha;
    }
   ...
   * @return gapi
   */
  public static function authenticate($email, $password, $logintoken = null, $logincaptcha = null) {
    $auth_method = new gapiClientLogin();
    $auth_method->fetchToken($email, $password, $logintoken, $logincaptcha);
