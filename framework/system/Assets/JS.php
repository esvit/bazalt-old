...
class Assets_JS
{
    ...
    {
        Assets_FileManager::getInstance()->add($file, 'js', $condition);
    }

    public static function getFiles()
    {
        return Assets_FileManager::getInstance()->getFiles('js');
    }
    ...
    public static function addPackage($name, $version = null)
    {
        ...
        $package = Assets_Package::getInstance()->getPackage($name, $version);
