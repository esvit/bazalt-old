...
class Logger
{
    ...
    public function startLog()
    {
        ...
        if (empty(self::$requestUniqueId)) {
            self::$requestUniqueId = DataType_Guid::newGuid()->toString();
        }
    ...
    {
        if(!DISABLE_LOG && $this->isSingleton) {
            file_put_contents($this->getSavePath(), implode("\n", self::$_debugs), FILE_APPEND);
            file_put_contents($this->getSavePath(), $this->showLogs(null, $this->category), FILE_APPEND);
        }
    }
