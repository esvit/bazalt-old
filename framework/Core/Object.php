...
abstract class Object
{
    ...
    public static function &getInstance()
    {
        ...
        if (!isset(self::$_objects[$lowerName]) || !is_object(self::$_objects[$lowerName])) {
            ...
            if (!$class instanceOf ISingleton) {
                throw new Exception_Interface('ISingleton', $className);
            }
    ...
    {
        if ($this instanceof ISingleton) {
            throw new Exception_Singleton('Object allow only single instance exists');
        }
    }
    ...
    public function __get($property)
    {
        ...
        throw new Exception_Property($property, Exception_Property::UNDEFINED);
    }
    ...
    public function __set($property, $value)
    {
        ...
        $propName = lcfirst($property);
        if ($property != $propName && property_exists($this, $propName)) {
            throw new Exception_Property($property, Exception_Property::READONLY);
        }
