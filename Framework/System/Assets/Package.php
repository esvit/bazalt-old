...
class Package implements Config_IConfigurable
{
    ...
    public static function &getInstance()
    {
        if (self::$instance == null) {
            ...
            Config_Loader::init('assets/packages', self::$instance);
        }
    ...
    {
        $this->globalFile = isset($config['global']) ? Config_Loader::replaceConstants($config['global']) : null;

        $this->packagesDir = isset($config['packagesDir']) ? Config_Loader::replaceConstants($config['packagesDir']) : null;
    }
