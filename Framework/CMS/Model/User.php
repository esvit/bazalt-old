...
class User extends Base\User
{
    ...
    public static function getByIdAndSession($id, $sessionId = null)
    {
        $q = ORM::select('Framework\CMS\Model\User u')
                ->leftJoin('Framework\CMS\Model\SiteRefUser ref', array('user_id', 'u.id'))
    ...
    {
        $q = ORM::select('Framework\CMS\Model\User u')
                ->innerJoin('Framework\CMS\Model\UserSetting ref', array('user_id', 'u.id'))
    ...
    public function updateLastActivity($time = null)
    {
        ...
        ORM::update('Framework\CMS\Model\User')
    ...
    public static function deleteByIds($ids)
    {
        ...
        $q = ORM::delete('Framework\CMS\Model\User a')
                ->whereIn('a.id', $ids)
    ...
    {
        $q = ORM::select('Framework\CMS\Model\User f')
