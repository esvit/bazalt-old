...
!function (win) {
    ...
    var Pomo = function () {
        ...
        this.getText = function (msg_id, options) {
            ...
            var context = options.context || false;
            var domain = options.domain || 'messages';
            var count = options.count || false;

            var escaped = escapeString(msg_id);

            me.storage = me.storage || {};
            me.storage.contents = me.storage.contents || {};
            me.storage.contents[domain] = me.storage.contents[domain] || {};
            ...
            if (!!me.storage.contents[domain] && !!me.storage.contents[domain][escaped]) {
                ...
                var is_bare_string = (typeof translation == 'string');
                if (!!variables) {
