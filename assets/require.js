...
(function(jQuery, window, undefined) {
    ...
    var matched, browser, oldInit = jQuery.fn.init, oldParseJSON = jQuery.parseJSON, // Note this does NOT include the #9521 XSS fix from 1.7!
    rquickExpr = /^(?:[^<]*(<[\w\W]+>)[^>]*|#([\w\-]*))$/;
...
require.config({
    ...
    shim: {
        ...
        "ng-editable-tree": {
            deps: [ "jquery.ui.touch-punch", "jquery.ui.nestedSortable" ]
        },
        "ng-finder": {
