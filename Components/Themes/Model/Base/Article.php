...
abstract class Article extends \Framework\CMS\ORM\Record
{
    ...
    {
        $this->hasRelation('User', new \Bazalt\ORM\Relation\One2One('Framework\CMS\User', 'user_id', 'id'));
        $this->hasRelation('Images', new \Bazalt\ORM\Relation\One2Many('Components\News\Model\ArticleImage', 'id', 'news_id'));
        $this->hasRelation('Category', new \Bazalt\ORM\Relation\One2One('Components\News\Model\Category', 'category_id', 'id'));
        $this->hasRelation('Region', new \Bazalt\ORM\Relation\One2One('ComGeo_Model_State', 'region_id', 'id'));

        $this->hasRelation('Tags', new \Bazalt\ORM\Relation\Many2Many('ComTags_Model_Tag', 'news_id', 'Components\News\Model\ArticleRefTag', 'tag_id'));
        $this->hasRelation('Comments', new \Bazalt\ORM\Relation\Many2Many('ComTags_Model_Tag', 'news_id', 'Components\News\Model\ArticleRefTag', 'tag_id'));

        $this->hasRelation('Company', new \Bazalt\ORM\Relation\One2One('ComEnterprise_Model_Company', 'company_id', 'id'));
    }
