...
class ComEcommerce_Controller_Admin_ExportImport extends CMS_Component_Controller
{
    public function exportImportAction()
    {
        ...
        $this->view->assign('categories', ComEcommerce_Model_Category::getCategories());
