...
abstract class Category extends \Framework\CMS\ORM\Record
{
    ...
    {
        $this->hasRelation('Elements', new \ORM_Relation_NestedSet('Components\News\Model\Category', 'site_id'));
        $this->hasRelation('PublicElements', new \ORM_Relation_NestedSet('Components\News\Model\Category', 'site_id', null, array('is_hidden' => '0', 'is_publish' => 1)));
    }
